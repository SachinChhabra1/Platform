...
stream, not the terminal gate. **The forward path is backend (R2–R8), all Founder-gated** — frontend
engineering is ~90–95% complete and the bottleneck is now the OD rulings (OD-1 critical, expires
