...
class Error {
  ...
  /// Machine-readable, stable across API versions.
  String code;

  /// Human-readable, in the requester's language.
  String message;

  /// Correlation id for tracing across services and logs.
  ...
  @override
  String toString() => 'Error[code=$code, message=$message, correlationId=$correlationId, retry=$retry]';
  ...
  static Error? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Error(
        ...
        retry: ErrorRetry.fromJson(json[r'retry']),
      );
    }
    return null;
  }
